...
// const USER_ROLES_WITH_ASSIGN = ["SPSUBEDT", "EDT", "CHRPT"];
...
//   useEffect(() => {
//     // Optionally, you could add any logic here that you want to run on component mount.
//     // For example, if you want the sidebar to be shown based on some condition:
//     const shouldShowSidebar = true; // Replace with your actual condition
